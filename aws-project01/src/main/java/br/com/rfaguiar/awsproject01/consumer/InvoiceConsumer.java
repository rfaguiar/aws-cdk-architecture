package br.com.rfaguiar.awsproject01.consumer;

import br.com.rfaguiar.awsproject01.model.Invoice;
import br.com.rfaguiar.awsproject01.model.SnsMessage;
...
public class InvoiceConsumer {
    ...
    private void processInvoiceNotification(S3EventNotification s3EventNotification) throws IOException {
        for (S3EventNotification.S3EventNotificationRecord s3EventNotificationRecord :
    ...
    private String downloadObject(String bucketName, String objectKey) throws IOException {
        ...
        try (InputStreamReader s3Stream = new InputStreamReader(s3Object.getObjectContent());
                BufferedReader bufferedReader = new BufferedReader(s3Stream)) {
            String content;
